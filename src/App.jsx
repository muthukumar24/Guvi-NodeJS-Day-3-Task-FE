...
function App() {
  ...
  const fetchMentors = async () => {
    try {
      const response = await axios.get('https://guvi-nodejs-day-3-task-be.onrender.com/api/mentors');
  ...
  const fetchStudents = async () => {
    try {
      const response = await axios.get('https://guvi-nodejs-day-3-task-be.onrender.com/api/students');
